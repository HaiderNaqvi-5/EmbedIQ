...
async def get_analytics(
    ...
    # Combine all 8 scalar queries into a single query to reduce DB roundtrips
    # Expected performance impact: Reduces database query overhead by combining 8 roundtrips into 1
    q_combined_summary = select(
    ...
    (
        ...
        _execute_first(q_combined_summary),
